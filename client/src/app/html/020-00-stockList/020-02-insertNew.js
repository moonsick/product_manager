angular.module('eventApp')
    .controller('insertNew_Ctr', function ($scope,executeResults ,$http, $route, $rootScope, $location ,$routeParams) {
        ...
        var product_count = 0;   // 입고수량 플래그 함수 1 일때 동작
        var product_cost = 0;   // 입고단가 플래그 함수 1 일때 동작
