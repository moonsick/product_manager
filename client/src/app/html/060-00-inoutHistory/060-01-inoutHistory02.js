angular.module('eventApp')
    .controller('inoutHistory02', function ($scope,executeResults ,$http, $route, $rootScope, $location ,$routeParams) {
        ...
        executeResults.day_move_out_list().then(function (data) {
        ...
        executeResults.day_move_out_list_return().then(function (data) {
            ...
            if ($scope.day_move_list_return[0].name !== "error") {
                ...
                executeResults.day_move_out_sub_list_return().then(function (data) {
