...
exports.stock_insert_go = function (req, res) {
    ...
    if(move_mod == '반품'){
        ...
        c.query(query.stock_insert_go, [product_id,company_id,member_id,move_mod,product_count,product_cost])
            ...
            .on('end', function () {
                c.query(query.product_count_update2, [product_count,product_id])
                    .on('result', function (res) {
                        res.on('row', function (row) {
                            sending.push(row);
                        });
...
exports.release_insert_go = function (req, res) {
    ...
    if(move_mod == '반품'){
        ...
        c.query(query.release_insert_go, [product_id,company_id,member_id,move_mod,product_count,product_cost])
            ...
            .on('end', function () {
                c.query(query.product_count_sub_update2, [product_count,product_id])
                    .on('result', function (res) {
                        res.on('row', function (row) {
                            sending.push(row);
                        });
...
exports.product_in_return_info_list = function (req, res) {
    var sending = [];
    var product_id = req.body.product_id;

    c.query(query.product_in_return_info_list, [product_id])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.product_out_return_info_list = function (req, res) {
    var sending = [];
    var product_id = req.body.product_id;

    c.query(query.product_out_return_info_list, [product_id])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_sub_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_sub_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_out_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_out_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_out_sub_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_out_sub_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_company_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_company_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_company_sub_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_company_sub_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_company_out_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_company_out_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.day_move_company_out_sub_list_return = function (req, res) {
    var sending = [];

    c.query(query.day_move_company_out_sub_list_return, [null])
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
