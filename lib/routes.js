...
module.exports = function (app) {
    ...
    app.route('/product_in_return_info_list').post(execute.product_in_return_info_list);
    ...
    app.route('/product_out_return_info_list').post(execute.product_out_return_info_list);
    ...
    app.route('/day_move_list_return').post(execute.day_move_list_return);
    ...
    app.route('/day_move_sub_list_return').post(execute.day_move_sub_list_return);
    ...
    app.route('/day_move_out_list_return').post(execute.day_move_out_list_return);
    ...
    app.route('/day_move_out_sub_list_return').post(execute.day_move_out_sub_list_return);
    ...
    app.route('/day_move_company_list_return').post(execute.day_move_company_list_return);
    ...
    app.route('/day_move_company_sub_list_return').post(execute.day_move_company_sub_list_return);
    ...
    app.route('/day_move_company_out_list_return').post(execute.day_move_company_out_list_return);
    ...
    app.route('/day_move_company_out_sub_list_return').post(execute.day_move_company_out_sub_list_return);
